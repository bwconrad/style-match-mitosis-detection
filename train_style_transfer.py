...
from src.style_transfer.data import BasicContentStyleDataModule

# Parse arguments
parser = LightningArgumentParser()
parser.add_lightning_class_args(pl.Trainer, None)
parser.add_lightning_class_args(AdaInModel, "model")
parser.add_lightning_class_args(BasicContentStyleDataModule, "data")
parser.add_argument(
    "--output_path",
    type=str,
...
# Setup model
dm = BasicContentStyleDataModule(**args["data"])
